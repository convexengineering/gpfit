...
class TestFit(unittest.TestCase):
    ...
    def test_error(self):
        ...
        self.assertAlmostEqual(f1.errors["rms_rel"], 8.12727e-07)
        self.assertAlmostEqual(f1.errors["rms_abs"], 7.43308e-07)
        self.assertAlmostEqual(f1.errors["rms_log"], 8.12726e-07)
        self.assertAlmostEqual(f1.errors["max_rel"], 3.52899e-06)
        self.assertAlmostEqual(f1.errors["max_abs"], 3.52899e-06)
        self.assertAlmostEqual(f2.errors["rms_rel"], 1.61329e-06)
        self.assertAlmostEqual(f2.errors["rms_abs"], 1.36908e-06)
        self.assertAlmostEqual(f2.errors["rms_log"], 1.61329e-06)
        self.assertAlmostEqual(f2.errors["max_rel"], 7.00807e-06)
        self.assertAlmostEqual(f2.errors["max_abs"], 7.00807e-06)
